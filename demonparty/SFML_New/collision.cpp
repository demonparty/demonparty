...
sf::IntRect Collision::GetAABB(const sf::Sprite& Object) {
	...
	sf::Vector2f pos = Object.getTransform().transformPoint(sf::Vector2f(0, 0));
 
    //Store the size so we can calculate the other corners
	sf::Vector2f size = sf::Vector2f(Object.getTexture()->getSize());
    ...
    B = Collision::RotatePoint(B, Angle);
    C = Collision::RotatePoint(C, Angle);
    D = Collision::RotatePoint(D, Angle);
 
    //Round off to int and set the four corners of our Rect
    int Left = static_cast<int> (Collision::MinValue(0.0f, B.x, C.x, D.x));
    int Top = static_cast<int> (Collision::MinValue(0.0f, B.y, C.y, D.y));
    int Right = static_cast<int> (Collision::MaxValue(0.0f, B.x, C.x, D.x));
    int Bottom = static_cast<int> (Collision::MaxValue(0.0f, B.y, C.y, D.y));
...
// 
//		sf::IntRect O1SubRect = sf::IntRect(Object1.getGlobalBounds());
//		sf::IntRect O2SubRect = sf::IntRect(Object2.getGlobalBounds());
// 
...
//		for (int i = Intersection.left; i < Intersection.; i++) {
...
bool Collision::CircleTest(const sf::Sprite& Object1, const sf::Sprite& Object2) {
	...
	float Radius1 = (Object1.getTexture()->getSize().x + Object1.getTexture()->getSize().y) / 4;
    float Radius2 = (Object2.getTexture()->getSize().x + Object2.getTexture()->getSize().y) / 4;
...
bool Collision::BoundingBoxTest(const sf::Sprite& Object1, const sf::Sprite& Object2) {
	...
	sf::Vector2f HalfSize1 = sf::Vector2f(Object1.getTexture()->getSize());
	sf::Vector2f HalfSize2 = sf::Vector2f(Object2.getTexture()->getSize());
